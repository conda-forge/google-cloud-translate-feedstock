About google-cloud-translate-feedstock
======================================
...
Development: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-translate
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-translate-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-translate-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `google-cloud-translate` can be installed with `conda`:
...
```
mamba install google-cloud-translate
```

It is possible to list all of the versions of `google-cloud-translate` available on your platform with `conda`:
...
```
mamba search google-cloud-translate --channel conda-forge
```
...
mamba repoquery search google-cloud-translate --channel conda-forge

# List packages depending on `google-cloud-translate`:
mamba repoquery whoneeds google-cloud-translate --channel conda-forge

# List dependencies of `google-cloud-translate`:
mamba repoquery depends google-cloud-translate --channel conda-forge
```
